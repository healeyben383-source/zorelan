      ...
      <section className="mb-12">
        ...
        <div className="rounded-2xl border border-white/10 p-6 space-y-3">
          <p className="text-white/80">The API is currently in early access. To request an API key, email:</p>
            ...
            className="inline-block text-white font-medium underline underline-offset-4"
          >
            api@zorelan.com
          </a>
  ...
  "meta": {
    ...
    "agreement_summary": "Both models recommend fixed pricing for recurring services."
      ...
      <section className="mb-12">
        ...
        <div className="rounded-2xl border border-white/10 p-6">
          <pre className="text-sm font-mono text-white/80 whitespace-pre-wrap">{`curl -X POST https://zorelan.com/api/decision \\
  ...
  -d '{"prompt": "Should I hire staff or stay solo?"}'`}</pre>
      ...
      <section>
        <div className="rounded-2xl border border-white/10 p-8 text-center space-y-4">
          ...
          <p className="text-white/50">Request early access and we&apos;ll set you up within 24 hours.</p>
